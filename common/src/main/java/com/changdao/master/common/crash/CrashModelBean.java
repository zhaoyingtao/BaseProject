package com.changdao.master.common.crash;
 ...
 * desc   :
 */
public class CrashModelBean implements Parcelable {
    ...
    protected CrashModelBean(Parcel in) {
    ...
    public CrashModelBean() {
    }

    public static final Creator<CrashModelBean> CREATOR = new Creator<CrashModelBean>() {
        @Override
        public CrashModelBean createFromParcel(Parcel in) {
            return new CrashModelBean(in);
        }

        @Override
        public CrashModelBean[] newArray(int size) {
            return new CrashModelBean[size];
        }
    };

...
public class CrashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView iv_more = findViewById(R.id.iv_more);
//
    ...
    private String getShareText(CrashModelBean model) {
    ...
    private void shareImage() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            Uri contentUri = FileProvider.getUriForFile(getApplicationContext(),"com.changdao.master.appcommon.provider", file);
